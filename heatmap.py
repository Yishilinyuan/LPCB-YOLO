...
def get_params():
    params = {
        'weight': '/Users/lyz/Downloads/pcb缺陷检测/yolov8-mobilenet_small_bifpn_c2fse_C_GIOU/weights/best.pt',
        'cfg': '/Users/lyz/Documents/experiment_result/02-缺陷检测/ultralytics-main-de/ultralytics/cfg/models/v8/mo'
               'bilenet/improveC2f/yolov8n-mobilenet_small+bifpn+c2fse.yaml',
        'device': 'cpu',
...
if __name__ == '__main__':
    ...
    images = '/Users/lyz/Downloads/杂七杂八/COCOpcb数据集/COCO_PCB/images/test/l_light_01_short_03_1_600.jpg'
    model(images, 'result')